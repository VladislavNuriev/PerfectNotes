...
import com.example.createnote.CreateNoteCommand
import com.example.createnote.CreateNoteState
import com.example.createnote.CreateNoteViewModel
            ...
            Scaffold(
                ...
                Column(
                    ...
                    TextField(
                        ...
                        onValueChange = { text ->
                            viewModel.processCommand(CreateNoteCommand.InputTitle(text))
                        },
                    ...
                    Button(
                        modifier = Modifier
                            ...
                            .fillMaxWidth(),
                        onClick = { viewModel.processCommand(CreateNoteCommand.SaveNote) },
