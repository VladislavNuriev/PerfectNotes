            ...
            Scaffold(
                ...
                Column(
                    ...
                    TextField(
                        ...
                        onValueChange = { text ->
                            viewModel.processCommand(InputTitle(text))
                        },
                    ...
                    currentState.note.content.filterIsInstance<ContentItem.Text>()
                        .forEach { contentItem ->
                            TextContent(
                                ...
                                onTextChanged = { text ->
                                    viewModel.processCommand(EditNoteCommand.InputContent(text))
                                }
                            )
                        }
                    Button(
                        modifier = Modifier
                            ...
                            .fillMaxWidth(),
                        onClick = { viewModel.processCommand(EditNoteCommand.SaveNote) },
